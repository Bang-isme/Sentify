...
- freshest backend-only rerun evidence on `2026-03-29`:
  - `npm test`: passed (`184` tests: `171` pass, `13` skipped, `0` fail)
  - `npm run test:realdb`: passed
