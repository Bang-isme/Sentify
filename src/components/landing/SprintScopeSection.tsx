  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1440px]">
        <div className={`mb-14 max-w-3xl ${revealClass()}`} style={revealStyle(0)}>
        ...
        <div ref={ref} className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_minmax(280px,0.8fr)]">
          ...
          <div className={revealClass()} style={revealStyle(150)}>
            <ScopeCard title={copy.sprint.outOfScopeTitle} icon="block" items={copy.sprint.outOfScopeItems} />
          </div>
          <article className={`rounded-[30px] border border-border-light bg-surface-white/90 p-7 shadow-sm dark:border-border-dark dark:bg-surface-dark/80 ${revealClass()}`} style={revealStyle(300)}>
