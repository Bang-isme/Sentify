  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1440px]">
        ...
        <div ref={ref} className="grid auto-rows-[minmax(180px,auto)] grid-cols-1 gap-6 md:grid-cols-6 lg:grid-cols-12">
          <div className={revealClass()} style={revealStyle(0)}>
            <OverviewCard />
          </div>
          {copy.dashboard.smallCards.map((card, index) => (
            <div key={card.title} className={`md:col-span-3 lg:col-span-4 ${revealClass()}`} style={revealStyle((index + 1) * 120)}>
              <SmallFeatureCard
                icon={card.icon}
                tag={card.tag}
                title={card.title}
          ...
          <div className={revealClass()} style={revealStyle(360)}>
            <SentimentCard />
          </div>
          <div className={revealClass()} style={revealStyle(480)}>
            <TrendCard />
          </div>
        </div>
      </div>
...
function SmallFeatureCard({
  ...
  return (
    <div className="group bento-card relative row-span-1 overflow-hidden rounded-2xl border border-border-light bg-surface-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-primary/60 dark:border-border-dark dark:bg-surface-dark dark:shadow-none">
